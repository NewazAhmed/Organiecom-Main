...
@foreach($banner as $item)
    <div class="carousel-item @if($loop->first) active @endif">
      <img height="300px" width="100%" src="{{asset($item->image_one)}}" alt="...">
      <div class="carousel-caption d-none d-md-block">
        <h1 style="position: relative;bottom: 80px;right: 200px;">{{$item->title}}</h1>
        <h5 style="position: relative;bottom: 70px;right: 200px;">{{$item->subtitle}}</h5>
      </div>
    </div>
@endforeach  
        ...
        <div class="container">
            <div class="row">
                <div class="categories__slider owl-carousel">
                    ...
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{asset($item->image_one)}}">
    ...
    <section class="featured spad">
        <div class="container">
            ...
            <div class="row featured__filter">
                ...
                @php
                  $product = \App\Product::where('category_id',$cat->id)->latest()->get()
                @endphp
                    ...
                    <div class="featured__item">
                        <div class="featured__item__pic set-bg" data-setbg="{{asset($pro->image_one)}}">
                            <ul class="featured__item__pic__hover">
                                <li><a href="{{url('add-to-wishlist/'.$pro->id)}}"><i class="fa fa-heart"></i></a></li>
                                ...
                                <li>
                                    <button id="frmSubmit" class="btn-stl" type="submit">
                        ...
                        <div class="featured__item__text">
                            <h6><a href="{{url('/shop-details/'.$pro->id)}}">{{$pro->product_name}}</a></h6>
                            <h5>{{$pro->price}}</h5>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <div class="banner__pic">
                        <img height="200px" width="100%" src="{{asset($item->image_one)}}" alt="">
                    </div>
                </div>
                @endforeach
            </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <p>{!!Str::limit($item->post_description,10)!!}</p>
                        </div>
                    </div>
                </div>
               @endforeach
