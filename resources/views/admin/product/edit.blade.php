             ...
             <div class="row">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <img class="img-thumbnail mb-3" height="220px" width="220px" src="{{asset($product->image_one)}}" alt="">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  <label class="form-control-label">First Image: <span class="tx-danger">*</span></label><br>
                  <img class="img-thumbnail mb-3" height="220px" width="220px" src="{{asset($product->image_two)}}" alt="">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <img class="img-thumbnail mb-3" height="220px" width="220px" src="{{asset($product->image_three)}}" alt="">
